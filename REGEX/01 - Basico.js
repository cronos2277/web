texto1 = `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis tristique ipsum quis est tincidunt`;
//O Exemplo mais basico, vai procurar se existe essa palavra na string e assim que achar para.
regex1 = /ipsum/; //Apenas retornara uma unica ocorrencia e para, uma vez que esta sem a flag g
console.table(texto1.match(regex1));

//Segundo Exemplo
texto2 = `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis tristique ipsum quis est tincidunt`;
...
regex2 = /ipsum/ig;
console.info("Segundo exemplo de Regex: ", texto2.match(regex2));
